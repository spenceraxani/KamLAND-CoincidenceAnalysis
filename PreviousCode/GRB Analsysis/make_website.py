...
for line in range(len(timeList1)):
    ...
    #f.writelines( '%s %s %s %s' %(nameList1[line], utcList1[line],T90List1[line],zList1[line]) + str('\n'))    
    f.writelines( '<tr>' + str('\n'))    
    f.writelines( '<th>%s</th>' %nameList1[line] + str('\n'))
    f.writelines( '<th>%s</th>' %utcList1[line] + str('\n'))
    f.writelines( '<th>%s</th>' %T90List1[line] + str('\n'))
    f.writelines( '<th>%s</th>' %zList1[line] + str('\n'))
    f.writelines( '<th> </th>'  + str('\n'))
    f.writelines( '</tr>' + str('\n'))    
    pass
f.close
