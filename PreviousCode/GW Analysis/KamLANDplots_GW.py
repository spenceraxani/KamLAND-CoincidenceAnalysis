...
## Datetime of LIGO event  #October 12, 2015 at 09:54:43 UTC
...
#print timediff_list
timediff_list2 = [b - a for a, b in zip(datetime75[:-1], datetime75[1:])]
...
plt.scatter(datetimeGWnolike, fieldGWnolike[energy], s=40, marker = "+") #s=30, lw=0,
plt.ylim([0,100])
plt.plot([GW150914, GW150914], [0, 100], color='k', linestyle='-', linewidth=2)
plt.plot([LVT151012, LVT151012], [0, 100], color='k', linestyle='-', linewidth=2)
plt.xlabel('Time of Event')
plt.ylabel('Event Energy (MeV)')
...
plt.savefig("./plots/TimeEnergy_GW_100MeV_nolike_withBothGW_SepOct2015.png")
#plt.show()
plt.gcf().clear()
