...
Int_t root_draw_8He9Li_time_correlation()
{
...
#if 0
  char input_filename[256]  = "./result/DelayedCoincidence-Muon-2011Paper.root";
  char output_filename[256] = "./result/8He9Li_spectrum_2011Paper.dat";
  char *ps_file = "./picture/picture_8He9Li_time_correlation_2011Paper.ps";
#endif

#if 1
  char input_filename[256]  = "./result/DelayedCoincidence-Muon-DS12.root";
  char output_filename[256] = "./result/8He9Li_spectrum_DS12.dat";
  char *ps_file = "./picture/picture_8He9Li_time_correlation_DS12.ps";
#endif
  ...
  //  const double eff = 0.9358; // sylinder cut efficiency hiroko
  const double eff = 0.958; // sylinder cut efficiency //hisashi
  //  const double eff = 0.938; // sylinder cut efficiency //shimizu
