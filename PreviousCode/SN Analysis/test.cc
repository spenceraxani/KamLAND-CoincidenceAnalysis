...
int main(int argc, char* argv[])
{
...
#if 1
  string ListFile  = "./analysis_list/dcvf-Kat.list-GRB";
  string Reactor = "./result/test.dat";
  //string Reactor = "./result/Observed-dcvf-Kat_0.9MeV.dat";
  //string Reactor = "./result/Observed-dcvf-Kat_0.9MeVwithLikelihood.dat";
  ...
  string Reactor = "./result/Observed-dcvf-Kat-shimizu.dat-2013-11000-11947-ishidoshiro";

  char root_output_filename[256]                       = "./result/DelayedCoincidence_shimizu_2013-11000-11947-ishidoshiro.root";
  char root_output_filename_likelihood_selection[256] = "./result/DelayedCoincidence_and_LikelihoodSelection_shimizu_2013-11000-11947-ishidoshiro.root";
  string Rungrade = "./result/Observed-dcvf-Kat-rungrade-shimizu.dat-2013-11000-11947-ishidoshiro";
#endif
...
//       rd = Rd;
      ...
      if (energy >= 2.5 && energy < 100.0 && N200OD < 5 && multiplicity <= 1) {
	...
	if (Rp >= 650.0 || Rd >= 650.0 || Rd <= 250) continue;
	...
	// if (zd > 0 && sqrt(xd*xd+yd*yd) < 250) continue;
	  ...
	  //if (Likelihood_Ratio > KVFLikelihoodRatio::Likelihood_Ratio_Cut()) {
	    ...
	    fReactor << run << " " <<  energy << " " <<  event.Prompt.UnixTime << " " << event.Prompt.EventNumber << " "
		     << event.Delayed.EventNumber << " " << xp << " "  << yp << " " << zp << " " << xd << " " << yd << " " << zd << " "
		     << run_grade << " " << multiplicity << " " << dt << " " << dl << " " << endl;	
