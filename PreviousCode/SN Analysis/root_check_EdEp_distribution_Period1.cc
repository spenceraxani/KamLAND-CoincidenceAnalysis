...
Int_t root_check_EdEp_distribution_Period1()
{
  // -------------------------------------------------------------------------------------------------------- //
  ...
  char delayed_coincidence_filename[256]                = "./result/DelayedCoincidence_2013-Period1.root";
  //  char delayed_coincidence_filename[256]                = "./result/DelayedCoincidence_2013-Period2.root";
  ...
  //  char delayed_coincidence_and_likelihood_filename[256] = "./result/DelayedCoincidence_and_LikelihoodSelection_2011Paper.root";
  char delayed_coincidence_and_likelihood_filename[256] = "./result/DelayedCoincidence_and_LikelihoodSelection_2013-Period1.root";
  //  char delayed_coincidence_and_likelihood_filename[256] = "./result/DelayedCoincidence_and_LikelihoodSelection_2013-Period2.root";

  //  char *ps_file = "./picture/picture_delayed_vertex.ps";
  //  char *ps_file = "./picture/picture_prompt_vertex.ps";
  //           char *ps_file = "./picture/picture_EdEp_2013_Period1_narrow2.ps";
  char *ps_file = "./picture/picture_EdEp_2013_Period2_narrow2.ps";
  // -------------------------------------------------------------------------------------------------------- //
  ...
  for (int o=0; o < binX; o++)
	...
	h ->SetBinContent(o, j , A/3.13);//period2
	h ->SetBinContent(o, j , A/4.1);//period1
...
int main(int argc, char** argv) {
  ...
  return root_check_EdEp_distribution_Period1();
}
#endif
