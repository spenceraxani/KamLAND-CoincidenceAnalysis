...
#if 1
  char input_filename[256]  = "./result/DelayedCoincidence-Muon-XePhase-11947.root";
  char output_filename[256] = "./result/8He9Li_spectrum_DS3.dat";
  char *ps_file = "./picture/picture_8He9Li_time_correlation_DS3.ps";
#endif
