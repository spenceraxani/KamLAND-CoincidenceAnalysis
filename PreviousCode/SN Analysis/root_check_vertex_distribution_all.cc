...
Int_t root_check_vertex_distribution_all()
{
  // -------------------------------------------------------------------------------------------------------- //
  ...
  //  char delayed_coincidence_filename[256]                = "./result/DelayedCoincidence_2013-10675.root";
  ...
  //  char delayed_coincidence_and_likelihood_filename[256] = "./result/DelayedCoincidence_and_LikelihoodSelection_2013-10675.root";
  ...
  //  char *ps_file = "./picture/picture_prompt_vertex_2013-9626.ps";
  //  char *ps_file = "./picture/picture_prompt_vertex_2013-10675.ps";
  char *ps_file = "./picture/picture_prompt_vertex_2013-11947.ps";
  //  char *ps_file = "./picture/picture_prompt_vertex_2013-11000-11947.ps";
  // -------------------------------------------------------------------------------------------------------- //
  ...
  graph -> SetLineColor(TColor::GetColor("#3300CC"));
  graph -> Draw("C");
  ...
  graph2 -> SetLineColor(TColor::GetColor("#3300CC"));
  graph2 -> Draw("C, same");
  ...
  graph3 -> SetLineColor(TColor::GetColor("#3300CC"));
  graph3 -> Draw("C, same");
...
int main(int argc, char** argv) {
  ...
  return root_check_vertex_distribution_all();
}
#endif
